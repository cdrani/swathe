...
<div class="flex justify-end mb-2">
    <button
        ...
        class="inline-flex place-content-center p-{small ? 1 : 2} bg-gray-800 w-{wh * 2} mr-2"
    >
        <svg
            viewBox="0 0 16 16"
            xmlns="http://www.w3.org/2000/svg"
            class="fill-white w-{wh} h-{wh} md:w-{wh + 1} md:h-{wh + 1}"
        >
    ...
    <button
        ...
        class="inline-flex place-content-center p-{small ? 1 : 2} bg-gray-800 w-{wh * 2}"
